...
public:
	...
	shared_ptr<CBSConflict> run(int a1, int a2, CBSNode& node, MDD* mdd_1, MDD* mdd_2);
...
private:
  ...
  unordered_map<ConstraintsHasher,
                unordered_map<ConstraintsHasher, shared_ptr<CBSConflict>, ConstraintsHasher::Hasher, ConstraintsHasher::EqNode>,
                ConstraintsHasher::Hasher, ConstraintsHasher::EqNode
                > lookupTable;

  shared_ptr<CBSConflict> findMutexConflict(int a1, int a2, CBSNode& node, MDD* mdd_1, MDD* mdd_2);
};
